...
export const isFutureDateInput = (value, referenceDate = new Date()) => {
...
export const calculateAgeAtDate = (birthDate, referenceDate = new Date()) => {
...
export const isMinor = (birthDate, referenceDate = new Date()) => {
  const age = calculateAgeAtDate(birthDate, referenceDate);
  return age !== null && age < 18;
};

export const getAmadeusPassengerTypeCode = (birthDate, referenceDate = new Date()) => {
  const age = calculateAgeAtDate(birthDate, referenceDate);
  if (age === null) return "";
  if (age < 2) return "INF";
